          ...
          <tbody>
            {users.map((user) => (
              <tr key={user.id}>
                ...
                <td className="px-3 border-2 border-slate-300">{user.name}</td>
                <td className="px-3 border-2 border-slate-300">{user.email}</td>
                <td className="px-3 border-2 border-slate-300">{user.phone}</td>
